...
public class Transferarticle {
	...
	public Transferarticle(int article_id, int user_id, String user_nikename, String user_image, String article_content,
			String article_image, String article_time) {
		super();
